      ...
      {accounts.length > 0 ? (
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full py-2 px-4 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center border-2 border-dashed border-blue-300 bg-blue-50 text-blue-600 hover:bg-blue-100 mb-3"
          >
            {isConnecting ? (
              'Connecting...'
            ) : (
          ...
          <button
            ...
            disabled={isConnecting}
            className="w-full py-2 px-4 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center border-2 border-dashed border-green-300 bg-green-50 text-green-600 hover:bg-green-100"
          >
        ...
        <div className="space-y-4">
          <p className="text-gray-600">
            Connect your Twitter account to start posting and managing your tweets.
          </p>
          ...
          <div className="space-y-3">
            ...
            <button
              onClick={() => setShowPinAuth(true)}
              disabled={isConnecting}
              className="w-full border-2 border-green-300 text-green-600 py-2 px-4 rounded-lg hover:bg-green-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center"
            >
              <FaPlus className="mr-2" />
              Real Twitter Login
            </button>
          ...
          <p className="text-xs text-gray-500 text-center">
            OAuth connects your currently logged-in account. Real Twitter Login uses Twitter's official authentication for any account.
          </p>
        </div>
      )}
